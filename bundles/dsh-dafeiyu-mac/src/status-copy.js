/**
 * 状态文案库：为不同状态/活动提供自然的中文短句。
 * 文案为复刻版自写，结构参考 QCYTSN/dsh-dafeiyu (MIT)。
 */

const COPY = Object.freeze({
  idle: ['我在这儿等新任务哦', '现在暂时没任务呢', '鱼儿正在待命中~'],
